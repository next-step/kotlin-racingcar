...
class RacingCarGame {
    companion object {
        ...
        fun main(args: Array<String>) {
            val racingCarGameInput = InputView.getInput()

            val numberOfCarInput = racingCarGameInput.numberOfCar
            val totalCountOfRoundInput = racingCarGameInput.totalCountOfRound
