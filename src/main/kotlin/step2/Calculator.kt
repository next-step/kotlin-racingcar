...
object Calculator {
    fun calculate(string: String?): String {
        ...
        InputStringValidator.validateString(addOperatorFirstPlace)
    ...
    private fun replaceOperatorFirstPlace(notContainedWhiteSpaceString: String) =
        when {
            ...
            MINUS.operation == notContainedWhiteSpaceString.first()
                .toString() -> notContainedWhiteSpaceString

            PLUS.operation == notContainedWhiteSpaceString.first()
                .toString() -> notContainedWhiteSpaceString
