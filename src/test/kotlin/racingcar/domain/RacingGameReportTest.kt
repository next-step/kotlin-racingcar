        ...
        context("마지막 랩에 가장 많이 움직인 자동차를 우승자로 조회할 수 있다") {
            it("우승자는 한명일 수 있다") {
                ...
                val lapReports = listOf(
                    LapReport(
                        listOf(
                            winner to Location(0),
                            CarName("참가자1") to Location(4),
                            CarName("참가자2") to Location(3)
                        )
                    ),
                    LapReport(
                        listOf(
            ...
            it("우승자는 한명 이상일 수 있다") {
                ...
                val lapReports = listOf(
                    LapReport(
                        listOf(
                            winner1 to Location(39),
                            winner2 to Location(4),
                            CarName("참가자") to Location(100)
                        )
                    ),
                    LapReport(
                        listOf(
                            winner1 to Location(500),
                            winner2 to Location(500),
                            CarName("참가자") to Location(200)
                        )
                    )
                )
