...
class RandomRacingRuleTest : BehaviorSpec({
    ...
    Given("RandomRacingRule 객체는") {
        val positiveRandomRacingRule = RandomRacingRule(intRandomGenerator, alwaysForward)
        When("4 이상의 정수가 나온다면") {
        ...
        val negativeRandomRacingRule = RandomRacingRule(intRandomGenerator, cantMove)
        When("4 미만의 정수가 나온다면") {
