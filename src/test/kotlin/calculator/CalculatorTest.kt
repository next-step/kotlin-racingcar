...
class CalculatorTest {
    ...
    @ParameterizedTest
    @CsvSource("2 + 3 * 4 / 2,10", "2 + 2,4", "4 - 1,3", "1 * 2,2", "4 / 1,4")
    ...
    @Test
    internal fun `입력값이 null이거나 빈 공백 문자열일 경우`() {
    ...
    @Test
    internal fun `최소한의 입력값이 입력되지 않았을 경우`() {
        assertThatIllegalArgumentException().isThrownBy {
