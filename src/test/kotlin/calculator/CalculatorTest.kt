...
internal class CalculatorTest {
    ...
    fun `뎃셈 연산`() {
        ...
        assertThat(Calculator.calculate("10 + 30")).isEqualTo(40)
        assertThat(Calculator.calculate("0 + 1 + 2")).isEqualTo(3)
    }

    @Test
    fun `뺄셈 연산`() {
        assertThat(Calculator.calculate("1 - 2 - 3")).isEqualTo(-4)
        assertThat(Calculator.calculate("10 - 30")).isEqualTo(-20)
        assertThat(Calculator.calculate("0 - 1 - 2")).isEqualTo(-3)
    }
    ...
    fun `곱센 연산`() {
        assertThat(Calculator.calculate("1 * 2 * 3")).isEqualTo(6)
        assertThat(Calculator.calculate("10 * 30")).isEqualTo(300)
        assertThat(Calculator.calculate("0 * 1 * 2")).isEqualTo(0)
    }

    @Test
    fun `나눗셈 연산`() {
        assertThat(Calculator.calculate("100 / 10 / 10")).isEqualTo(1)
