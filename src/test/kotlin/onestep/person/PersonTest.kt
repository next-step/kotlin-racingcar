...
class PersonTest {
    @Test
    fun constructor() {
        val person = Person(name = "조남재", age = 30, nickname = "조남재")
        assertThat(person.name).isEqualTo("조남재")
        person.nickname = "namjackson"
        assertThat(person.nickname).isEqualTo("namjackson")
    }
